...
void 0 === ewww_webp_supported && (ewww_webp_supported = !1),
  ...
  (function (e, t) {
              ...
              (i = e.target.getAttribute("data-back")) &&
                ...
                0 === i.search(/\[/) ||
                  (o(e.target) &&
                    ...
                    (i = g.hC(e.target, "wp-block-cover")
                      ? (g.hC(e.target, "has-parallax")
                          ? ((a = Math.round(u.screen.width * t)),
                            (r = Math.round(u.screen.height * t)))
                          : r < 300 && (r = 430),
                        s(i, a, r, "bg-cover"))
                ...
                -1 === e.target.style.backgroundImage.search(/^initial/)
                  ...
                  : (e.target.style.backgroundImage =
                      "url(" + (n.test(i) ? JSON.stringify(i) : i) + ")"))));
        },
        !1
      ));
    function h(e) {
    ...
    function e(e = !1) {
      e.type && "load" === e.type && g.autoSizer.checkElems(),
        u.devicePixelRatio;
      var t,
  ...
  (function (e, t) {
    ...
    if (
      (!(function () {
        ...
        for (e in ((h = i.lazySizesConfig || i.lazysizesConfig || {}), t))
          e in h || (h[e] = t[e]);
      })(),
    ...
    var j,
      ...
      fe =
        ...
        (de = H(function (t, e, a, i, r) {
          var n, o, s, l, d;
          (s = L(t, "lazybeforeunveil", e)).defaultPrevented ||
            (i && (a ? c(t, h.autosizesClass) : t.setAttribute("sizes", i)),
            (n = t[v](h.srcsetAttr)),
            (a = t[v](h.srcAttr)),
            ...
            (s = { target: t }),
            c(t, h.loadingClass),
            l && (clearTimeout(T), (T = y(ge, 2500)), x(t, le, !0)),
        ...
        })),
        {
          _: function () {
            (O = n.now()),
              ...
              g.elements.length ? (he(), M._lsFlush()) : oe();
          },
          ...
          unveil: (ce = function (e) {
            ...
            e._lazyRace ||
              (((!(r =
                ...
                r && _e.updateElem(e, !0, e.offsetWidth),
                (e._lazyRace = !0),
                ie++,
                de(e, t, r, i, a)));
          }),
          ...
          if (u[t] && !u[t]._lazyRace)
            if (!te || (g.prematureUnveil && g.prematureUnveil(u[t]))) ce(u[t]);
              ...
              l ||
                ...
                (c = h.hFac),
                (U = null),
                ae < d && ie < 1 && 2 < re && 2 < B && !f.hidden
                  ? ((ae = d), (re = 0))
                  : (ae = 1 < B && 1 < re && ie < 6 ? l : 0)),
              s !== r &&
                ((P = innerWidth + r * c),
                (q = innerHeight + r),
                (n = -1 * r),
    ...
    function be() {
      R ||
        (n.now() - O < 999
          ? y(be, 999)
          : ((R = !0), (h.loadMode = 3), oe(), e("scroll", ye, !0)));
    }
    var ze,
      we,
      Ce,
    ...
    function Ae(e, t, a) {
      ...
      i &&
        ((a = W(e, i, a)),
        (t = L(e, "lazybeforesizes", { width: a, dataAttr: !!t }))
          .defaultPrevented ||
